$(document).ready(function () {
    ...
    */
    ...
    $(document).mousemove(function (event) {
        ...
        console.log("coordenadas " + event.pageX + " en x");
        console.log("coordenadas " + event.pageY + " en y");

        // se captura un div y se lo mueve de acuerdo con las coordenadas del mouse 
        $("#sigueme").css("left", event.pageX).css("top", event.pageY);
    })
});