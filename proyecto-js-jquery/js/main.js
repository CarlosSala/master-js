$(document).ready(function () {
  // esta condicion se utiliza para solo ejecutar aquello necesario,
  // como en este caso en que el archivo main.js es compartido por varios html
  ...
  $(".subir").click(function (e) {
    // para que el link cumpla su funcion sin redireccionar a ninguna parte
    // pasar un parametro cualquiera a la funcion
    e.preventDefault();
  ...
  if (form_name1 != null && form_name1 != "undefined") {
    ...
    about_parrafo.html(
      "<br><strong> Bienvenido, " + form_name1 + " " + "</strong>"
    );
