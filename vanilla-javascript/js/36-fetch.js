...
// api rest es un servicio que devuelve datos en json
// simulando un backend

// fetch (ajax) Asynchronous Javascript and XML o 
// peticiones a servicios de api rest
...
// esta funcion contiene un objeto json y una promesa,
// para simular una peticion local
function getInfo() {
...
getUsers()
    ...
    .then(users => {
        // de toda la informacion venida en el objeto json 
        // se le pasa a la funcion solo aquella de interes 
    ...
    .then(data => {
        // console.log(data);
        // la informacion se pasa a un div para mostrarse en pantalla
...
// esta funcion trabaja la informacion u objeto recibido del api rest
...
*/
// las promesas suelen utilizarse cuando se leen archivos, enviar cosas
// por post o ajax