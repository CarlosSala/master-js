...
if (indice > -1 ){
// el metodo .splice() elimina elementos, indice es la ubicación
// y del primer elemento eliminado, el segundo parametro o numero representa la cantidad
// de elementos que se eliminarán a partir de esa posición
...
for (let indice in equipos){
    document.write(equipos [indice] + "<br>");
}
*/
